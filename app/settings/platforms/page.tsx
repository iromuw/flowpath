      ...
      <div className="bg-white rounded-xl border border-[rgba(26,101,90,0.15)] p-6">
        ...
        <form onSubmit={handleAdd} className="flex gap-2">
          <input
            ...
            className="flex-1 px-3 py-2 text-sm rounded-lg border border-[rgba(26,101,90,0.15)] bg-[#E6F4F1] text-[#1A2520] placeholder:text-[#8AADA8] focus:outline-none focus:ring-2 focus:ring-[#0FA878]/30 focus:border-transparent transition-colors"
          />
          <button
            type="submit"
